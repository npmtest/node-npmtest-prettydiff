...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-prettydiff/node_modules/prettydiff/api/node-local.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-prettydiff/node_modules/prettydiff/api/node-local.js</span></h1>
    <h2>
        
        Statements: <span class="metric">29.82% <small>(359 / 1204)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">2.38% <small>(24 / 1010)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">15% <small>(9 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">29.82% <small>(359 / 1204)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-prettydiff/node_modules/prettydiff/api/</a> &#187; node-local.js</div>
</div>
<div class="body">
...
3284
3285
3286</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
(function pdNodeLocal() {
    ...
    var localPath      = (process.cwd() === "/" || (/^([a-z]:\\)$/).test(process.cwd()) === true)
            ? <span class="branch-0 cbranch-no" title="branch not covered" >__dirname.replace(/(api)$/, "")</span>
            : "../",
        cwd            = (process.cwd() === "/")
...
&nbsp;
        ...
        ender          = <span class="fstat-no" title="function not covered" >function pdNodeLocal__ender() {</span>
<span class="cstat-no" title="statement not covered" >            var plural = (<span class="fstat-no" title="function not covered" >function pdNodeLocal__ender_plural() {</span></span>
...
<span class="cstat-no" title="statement not covered" >                        if (diffCount[a] === 1) {</span>
<span class="cstat-no" title="statement not covered" >                            arr.push("");</span>
                        } else {
<span class="cstat-no" title="statement not covered" >                            arr.push("s");</span>
                        }
                    }
<span class="cstat-no" title="statement not covered" >                    if (clidata[1].length === 1) {</span>
<span class="cstat-no" title="statement not covered" >                        arr.push("");</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        arr.push("s");</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (clidata[0].length === 1) {</span>
<span class="cstat-no" title="statement not covered" >                        arr.push("");</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        arr.push("s");</span>
                    }
<span class="cstat-no" title="statement not covered" >                    return arr;</span>
                ...
                log    = [],
                time   = 0;
<span class="cstat-no" title="statement not covered" >            if (enderflag === true) {</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (options.endquietly !== "log" &amp;&amp; (method === "filescreen" || method === "screen")) {</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
&nbsp;
            ...
            // (sub)directories)
<span class="cstat-no" title="statement not covered" >            if ((method !== "directory" &amp;&amp; method !== "subdirectory") || sfiledump.length === 1) {</span>
<span class="cstat-no" title="statement not covered" >                diffCount[1] = 1;</span>
<span class="cstat-no" title="statement not covered" >                diffCount.push("1 file");</span>
<span class="cstat-no" title="statement not covered" >                plural[1] = "";</span>
            } else {
<span class="cstat-no" title="statement not covered" >                diffCount.push(sfiledump.length + " files");</span>
            }
<span class="cstat-no" title="statement not covered" >            if (options.diffcli === true &amp;&amp; options.mode === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                if (options.summaryonly === true &amp;&amp; clidata[2].length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    log.push(lf + "Files changed:" + lf);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(colors.filepath.start);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(clidata[2].join(lf));</span>
<span class="cstat-no" title="statement not covered" >                    log.push(colors.filepath.end);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(lf + lf);</span>
                }
<span class="cstat-no" title="statement not covered" >                if (clidata[0].length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    log.push(lf + "Files deleted:" + lf);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(colors.del.lineStart);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(clidata[0].join(lf));</span>
<span class="cstat-no" title="statement not covered" >                    log.push(colors.del.lineEnd);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(lf + lf);</span>
                }
<span class="cstat-no" title="statement not covered" >                if (clidata[1].length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    log.push(lf + "Files inserted:" + lf);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(colors.ins.lineStart);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(clidata[1].join(lf));</span>
<span class="cstat-no" title="statement not covered" >                    log.push(colors.ins.lineEnd);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(lf + lf);</span>
                }
            }
<span class="cstat-no" title="statement not covered" >            log.push(lf + "Pretty Diff ");</span>
<span class="cstat-no" title="statement not covered" >            if (options.mode === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                if (method !== "directory" &amp;&amp; method !== "subdirectory") {</span>
<span class="cstat-no" title="statement not covered" >                    log.push("found ");</span>
<span class="cstat-no" title="statement not covered" >                    log.push(diffCount[0]);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(" difference");</span>
<span class="cstat-no" title="statement not covered" >                    log.push(plural[0]);</span>
...
<span class="cstat-no" title="statement not covered" >                    log.push(" difference");</span>
<span class="cstat-no" title="statement not covered" >                    log.push(plural[0]);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(" in ");</span>
<span class="cstat-no" title="statement not covered" >                    log.push(diffCount[1]);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(" file");</span>
<span class="cstat-no" title="statement not covered" >                    log.push(plural[1]);</span>
<span class="cstat-no" title="statement not covered" >                    log.push(" out of ");</span>
                }
            } else <span class="cstat-no" title="statement not covered" >if (options.mode === "beautify") {</span>
<span class="cstat-no" title="statement not covered" >                log.push("beautified ");</span>
            } else <span class="cstat-no" title="statement not covered" >if (options.mode === "minify") {</span>
<span class="cstat-no" title="statement not covered" >                log.push("minified ");</span>
            } else <span class="cstat-no" title="statement not covered" >if (options.mode === "parse") {</span>
<span class="cstat-no" title="statement not covered" >                log.push("parsed ");</span>
            }
<span class="cstat-no" title="statement not covered" >            if (options.mode !== "diff" || method === "directory" || method === "subdirectory") {</span>
<span class="cstat-no" title="statement not covered" >                log.push(diffCount[diffCount.length - 1]);</span>
<span class="cstat-no" title="statement not covered" >                log.push(". ");</span>
            }
<span class="cstat-no" title="statement not covered" >            if (options.mode === "diff" &amp;&amp; (method === "directory" || method === "subdirectory")) {</span>
<span class="cstat-no" title="statement not covered" >                log.push(clidata[1].length);</span>
<span class="cstat-no" title="statement not covered" >                log.push(" file");</span>
<span class="cstat-no" title="statement not covered" >                log.push(plural[2]);</span>
<span class="cstat-no" title="statement not covered" >                log.push(" added. ");</span>
<span class="cstat-no" title="statement not covered" >                log.push(clidata[0].length);</span>
<span class="cstat-no" title="statement not covered" >                log.push(" file");</span>
<span class="cstat-no" title="statement not covered" >                log.push(plural[3]);</span>
<span class="cstat-no" title="statement not covered" >                log.push(" deleted. Executed in ");</span>
            } else {
<span class="cstat-no" title="statement not covered" >                log.push("Executed in ");</span>
            }
<span class="cstat-no" title="statement not covered" >            time = (Date.now() - startTime) / 1000;</span>
<span class="cstat-no" title="statement not covered" >            log.push(time);</span>
<span class="cstat-no" title="statement not covered" >            log.push(" second");</span>
<span class="cstat-no" title="statement not covered" >            if (time !== 1) {</span>
<span class="cstat-no" title="statement not covered" >                log.push("s");</span>
            }
<span class="cstat-no" title="statement not covered" >            log.push("." + lf);</span>
<span class="cstat-no" title="statement not covered" >            console.log(log.join(""));</span>
<span class="cstat-no" title="statement not covered" >            enderflag = true;</span>
        },
&nbsp;
        //extract errorcount from diff report files for ender stats
        counter        = <span class="fstat-no" title="function not covered" >function pdNodeLocal__counter(x) {</span>
<span class="cstat-no" title="statement not covered" >            var num = Number(x.substring(x.indexOf("&lt;em&gt;") + 4, x.indexOf("&lt;/em&gt;")));</span>
<span class="cstat-no" title="statement not covered" >            if (num &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                diffCount[0] += num;</span>
<span class="cstat-no" title="statement not covered" >                diffCount[1] += 1;</span>
            }
...
&nbsp;
        ...
        reports        = <span class="fstat-no" title="function not covered" >function pdNodeLocal__reports() {</span>
<span class="cstat-no" title="statement not covered" >            var result = prettydiff.api(options);</span>
<span class="cstat-no" title="statement not covered" >            if (options.mode !== "parse" &amp;&amp; result[0].indexOf("Error: ") === 0) {</span>
<span class="cstat-no" title="statement not covered" >                return [result[0], ""];</span>
            }
<span class="cstat-no" title="statement not covered" >            html[7]  = options.color;</span>
<span class="cstat-no" title="statement not covered" >            html[10] = result[0];</span>
<span class="cstat-no" title="statement not covered" >            if (options.jsscope !== "none" &amp;&amp; options.mode === "beautify" &amp;&amp; (options.lang === "javascript" || options.lang === "auto")) {</span>
<span class="cstat-no" title="statement not covered" >                html[12] = builder.script.beautify;</span>
...
&nbsp;
        ...
        error          = (function pdNodeLocal__error() {
            var a       = [],
                ...
                vallist = <span class="fstat-no" title="function not covered" >function pdNodeLocal__vallist(x) {</span>
<span class="cstat-no" title="statement not covered" >                    var value = x.split(":\x1B[39m"),</span>
                        items = value[1].split(","),
                        len   = items.length,
                        b     = 0;
<span class="cstat-no" title="statement not covered" >                    for (b = 0; b &lt; len; b += 1) {</span>
<span class="cstat-no" title="statement not covered" >                        items[b] = items[b].replace(/\s(?=\w)/, " " + color.string) + "\x1B[39m";</span>
                    }
<span class="cstat-no" title="statement not covered" >                    return value[0] + ":\x1B[39m" + items.join(",");</span>
                };
            a.push(lf);
...
&nbsp;
        ...
        fileWrite      = <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileWrite(data) {</span>
<span class="cstat-no" title="statement not covered" >            var dirs     = data</span>
                    .localpath
                    .split(path.sep),
                ...
                count    = 1,
                writing  = <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileWrite_writing(ending, dataA) {</span>
<span class="cstat-no" title="statement not covered" >                    if (dataA.binary === true) {</span>
<span class="cstat-no" title="statement not covered" >                        fs</span>
                            .writeFile(dataA.finalpath, dataA.file, <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileWrite_writing_writeFileBinary(err) {</span>
<span class="cstat-no" title="statement not covered" >                                if (err !== null) {</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(lf + "Error writing binary output." + lf);</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(err);</span>
                                }
<span class="cstat-no" title="statement not covered" >                                total[1] += 1;</span>
<span class="cstat-no" title="statement not covered" >                                if (options.report === true) {</span>
<span class="cstat-no" title="statement not covered" >                                    total[0] -= 1;</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (total[1] === total[0]) {</span>
<span class="cstat-no" title="statement not covered" >                                    ender();</span>
                                }
                            });
                    } else <span class="cstat-no" title="statement not covered" >if (dataA.file === "") {</span>
<span class="cstat-no" title="statement not covered" >                        fs</span>
                            .writeFile(dataA.finalpath + ending, "", <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileWrite_writing_writeFileEmpty(err) {</span>
<span class="cstat-no" title="statement not covered" >                                if (err !== null) {</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(lf + "Error writing empty output." + lf);</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(err);</span>
                                } else <span class="cstat-no" title="statement not covered" >if (method === "file") {</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(lf + "Empty file successfully written to file.");</span>
                                }
<span class="cstat-no" title="statement not covered" >                                total[1] += 1;</span>
<span class="cstat-no" title="statement not covered" >                                if (total[1] === total[0]) {</span>
<span class="cstat-no" title="statement not covered" >                                    ender();</span>
                    ...
                    } else <span class="cstat-no" title="statement not covered" >if (ending.indexOf("-report") === 0) {</span>
<span class="cstat-no" title="statement not covered" >                        fs</span>
                            .writeFile(dataA.finalpath + ending, dataA.report[1], <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileWrite_writing_writeFileReport(err) {</span>
<span class="cstat-no" title="statement not covered" >                                if (err !== null) {</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(lf + "Error writing report output." + lf);</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(err);</span>
                                } else <span class="cstat-no" title="statement not covered" >if (method === "file") {</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(lf + "Report successfully written to file.");</span>
                                }
<span class="cstat-no" title="statement not covered" >                                total[1] += 1;</span>
<span class="cstat-no" title="statement not covered" >                                if (total[1] === total[0]) {</span>
<span class="cstat-no" title="statement not covered" >                                    ender();</span>
...
<span class="cstat-no" title="statement not covered" >                        fs</span>
                            .writeFile(dataA.finalpath + ending, dataA.report[0], <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileWrite_writing_writeFileText(err) {</span>
<span class="cstat-no" title="statement not covered" >                                if (err !== null) {</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(lf + "Error writing file output." + lf);</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(err);</span>
                                } else <span class="cstat-no" title="statement not covered" >if (method === "file") {</span>
<span class="cstat-no" title="statement not covered" >                                    console.log(lf + "File successfully written.");</span>
                                }
<span class="cstat-no" title="statement not covered" >                                total[1] += 1;</span>
<span class="cstat-no" title="statement not covered" >                                if (total[1] === total[0]) {</span>
<span class="cstat-no" title="statement not covered" >                                    ender();</span>
                ...
                files    = <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileWrite_files(dataB) {</span>
<span class="cstat-no" title="statement not covered" >                    if (dataB.binary === true) {</span>
<span class="cstat-no" title="statement not covered" >                        writing("", dataB);</span>
                    } else <span class="cstat-no" title="statement not covered" >if (options.mode === "diff" || (options.mode === "beautify" &amp;&amp; options.jsscope !== "none")) {</span>
<span class="cstat-no" title="statement not covered" >                        writing(suffix, dataB);</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        if (options.report === true) {</span>
<span class="cstat-no" title="statement not covered" >                            writing(suffix, dataB);</span>
                        }
<span class="cstat-no" title="statement not covered" >                        writing("", dataB);</span>
                ...
                newdir   = <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileWrite_newdir(dataC) {</span>
<span class="cstat-no" title="statement not covered" >                    fs</span>
                        .mkdir(address.oabspath + dirs.slice(0, count).join(path.sep), <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileWrite_newdir_callback() {</span>
<span class="cstat-no" title="statement not covered" >                            count += 1;</span>
<span class="cstat-no" title="statement not covered" >                            if (count &lt; dirs.length) {</span>
<span class="cstat-no" title="statement not covered" >                                pdNodeLocal__fileWrite_newdir(dataC);</span>
                            } else {
<span class="cstat-no" title="statement not covered" >                                files(dataC);</span>
                            }
                        });
                };
<span class="cstat-no" title="statement not covered" >            options.source = sfiledump[data.index];</span>
<span class="cstat-no" title="statement not covered" >            if (options.mode === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                data.finalpath = address.oabspath + dirs.join("__") + "__" + filename;</span>
<span class="cstat-no" title="statement not covered" >                options.diff   = dfiledump[data.index];</span>
            } else {
<span class="cstat-no" title="statement not covered" >                data.finalpath = address.oabspath + dirs.join(path.sep);</span>
            }
<span class="cstat-no" title="statement not covered" >            if (data.binary === true) {</span>
<span class="cstat-no" title="statement not covered" >                if (dirs.length &gt; 1 &amp;&amp; options.mode !== "diff") {</span>
<span class="cstat-no" title="statement not covered" >                    newdir(data);</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    files(data);</span>
                }
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
<span class="cstat-no" title="statement not covered" >            data.report = reports();</span>
<span class="cstat-no" title="statement not covered" >            if (options.mode === "parse") {</span>
<span class="cstat-no" title="statement not covered" >                data.report[0] = JSON.stringify(data.report[0]);</span>
            }
<span class="cstat-no" title="statement not covered" >            if (options.mode === "diff") {</span>
...
<span class="cstat-no" title="statement not covered" >            if (data.report[0].indexOf("Error") === 0) {</span>
<span class="cstat-no" title="statement not covered" >                if (data.last === true) {</span>
<span class="cstat-no" title="statement not covered" >                    ender();</span>
                }
<span class="cstat-no" title="statement not covered" >                return console.log(data.report[0]);</span>
            }
<span class="cstat-no" title="statement not covered" >            if (dirs.length &gt; 1 &amp;&amp; options.mode !== "diff") {</span>
<span class="cstat-no" title="statement not covered" >                newdir(data);</span>
            } else {
...
&nbsp;
        ...
        cliWrite       = <span class="fstat-no" title="function not covered" >function pdNodeLocal__cliWrite(output, itempath, last) {</span>
<span class="cstat-no" title="statement not covered" >            var a      = 0,</span>
                plural = "",
                pdlen  = output[0].length;
<span class="cstat-no" title="statement not covered" >            diffCount[0] += output[output.length - 1];</span>
<span class="cstat-no" title="statement not covered" >            diffCount[1] += 1;</span>
<span class="cstat-no" title="statement not covered" >            if (options.summaryonly === true) {</span>
<span class="cstat-no" title="statement not covered" >                clidata[2].push(itempath);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                if (diffCount[0] !== 1) {</span>
<span class="cstat-no" title="statement not covered" >                    plural = "s";</span>
                }
<span class="cstat-no" title="statement not covered" >                if (options.readmethod === "screen" || (options.readmethod === "auto" &amp;&amp; method === "screen")) {</span>
<span class="cstat-no" title="statement not covered" >                    console.log(lf + "Screen input with " + diffCount[0] + " difference" + plural);</span>
                } else <span class="cstat-no" title="statement not covered" >if (output[5].length === 0) {</span>
<span class="cstat-no" title="statement not covered" >                    console.log(lf + colors.filepath.start + itempath + lf + "Line: " + output[0][a] + colors.filepath.end);</span>
                }
<span class="cstat-no" title="statement not covered" >                for (a = 0; a &lt; pdlen; a += 1) {</span>
<span class="cstat-no" title="statement not covered" >                    if (output[0][a + 1] !== undefined &amp;&amp; output[0][a] === output[2][a + 1] &amp;&amp; output[2][a] === output[0][a + 1] &amp;&amp; output[0][a] !== output[2][a]) {</span>
<span class="cstat-no" title="statement not covered" >                        if (options.readmethod === "screen" || (options.readmethod === "auto" &amp;&amp; method === "screen")) {</span>
<span class="cstat-no" title="statement not covered" >                            console.log(lf + "Line: " + output[0][a] + colors.filepath.end);</span>
                        } else {
<span class="cstat-no" title="statement not covered" >                            console.log(lf + colors.filepath.start + itempath + lf + "Line: " + output[0][a] + colors.filepath.end);</span>
                        }
<span class="cstat-no" title="statement not covered" >                        if (output[3][a - 2] !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >                            console.log(output[3][a - 2]);</span>
                        }
<span class="cstat-no" title="statement not covered" >                        if (output[3][a - 1] !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >                            console.log(output[3][a - 1]);</span>
                        }
                    }
<span class="cstat-no" title="statement not covered" >                    if (output[4][a] === "delete") {</span>
<span class="cstat-no" title="statement not covered" >                        console.log(colors.del.lineStart + output[1][a].replace(/\\x1B/g, "\\x1B").replace(/&lt;p(d)&gt;/g, colors.del.charStart).replace(/&lt;\/pd&gt;/g, colors.del.charEnd) + colors.del.lineEnd);</span>
                    } else <span class="cstat-no" title="statement not covered" >if (output[4][a] === "insert") {</span>
<span class="cstat-no" title="statement not covered" >                        console.log(colors.ins.lineStart + output[3][a].replace(/\\x1B/g, "\\x1B").replace(/&lt;p(d)&gt;/g, colors.ins.charStart).replace(/&lt;\/pd&gt;/g, colors.ins.charEnd) + colors.ins.lineEnd);</span>
                    } else <span class="cstat-no" title="statement not covered" >if (output[4][a] === "equal" &amp;&amp; a &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >                        console.log(output[3][a]);</span>
                    } else <span class="cstat-no" title="statement not covered" >if (output[4][a] === "replace") {</span>
<span class="cstat-no" title="statement not covered" >                        console.log(colors.del.lineStart + output[1][a].replace(/\\x1B/g, "\\x1B").replace(/&lt;p(d)&gt;/g, colors.del.charStart).replace(/&lt;\/pd&gt;/g, colors.del.charEnd) + colors.del.lineEnd);</span>
<span class="cstat-no" title="statement not covered" >                        console.log(colors.ins.lineStart + output[3][a].replace(/\\x1B/g, "\\x1B").replace(/&lt;p(d)&gt;/g, colors.ins.charStart).replace(/&lt;\/pd&gt;/g, colors.ins.charEnd) + colors.ins.lineEnd);</span>
                    }
                }
            }
<span class="cstat-no" title="statement not covered" >            if (last === true) {</span>
<span class="cstat-no" title="statement not covered" >                ender();</span>
            }
        },
&nbsp;
        //write output to screen executed from fileComplete
        screenWrite    = <span class="fstat-no" title="function not covered" >function pdNodeLocal__screenWrite() {</span>
<span class="cstat-no" title="statement not covered" >            var report = [];</span>
<span class="cstat-no" title="statement not covered" >            if (options.mode === "diff" &amp;&amp; options.diffcli === true) {</span>
<span class="cstat-no" title="statement not covered" >                return cliWrite(prettydiff.api(options), "", false);</span>
            }
<span class="cstat-no" title="statement not covered" >            if (options.mode === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                return console.log(reports()[0]);</span>
            }
<span class="cstat-no" title="statement not covered" >            if (options.jsscope !== "none" &amp;&amp; options.mode === "beautify" &amp;&amp; (options.lang === "javascript" || options.lang === "auto")) {</span>
<span class="cstat-no" title="statement not covered" >                return console.log(reports()[0]);</span>
            }
<span class="cstat-no" title="statement not covered" >            report = prettydiff.api(options);</span>
<span class="cstat-no" title="statement not covered" >            if (options.mode === "parse") {</span>
<span class="cstat-no" title="statement not covered" >                report[0] = JSON.stringify(report[0]);</span>
            }
<span class="cstat-no" title="statement not covered" >            total[1] += 1;</span>
<span class="cstat-no" title="statement not covered" >            console.log(report[0]);</span>
<span class="cstat-no" title="statement not covered" >            if (total[0] === total[1] || options.readmethod === "screen" || options.readmethod === "auto") {</span>
<span class="cstat-no" title="statement not covered" >                ender();</span>
            }
        },
&nbsp;
        //generate the diff output for CLI from files
        cliFile        = <span class="fstat-no" title="function not covered" >function pdNodeLocal__cliFile(data) {</span>
<span class="cstat-no" title="statement not covered" >            options.source = sfiledump[data.index];</span>
<span class="cstat-no" title="statement not covered" >            options.diff   = dfiledump[data.index];</span>
<span class="cstat-no" title="statement not covered" >            if (options.source.indexOf("undefined") === 0) {</span>
<span class="cstat-no" title="statement not covered" >                options.source = options</span>
                    .source
                    .replace("undefined", "");
            }
<span class="cstat-no" title="statement not covered" >            if (options.diff.indexOf("undefined") === 0) {</span>
<span class="cstat-no" title="statement not covered" >                options.diff = options</span>
                    .diff
                    .replace("undefined", "");
            }
<span class="cstat-no" title="statement not covered" >            if (typeof options.context !== "number" || options.context &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                console.log(lf + colors.filepath.start + data.localpath + colors.filepath.end);</span>
            }
<span class="cstat-no" title="statement not covered" >            cliWrite(prettydiff.api(options), data.localpath, data.last);</span>
        },
&nbsp;
        // is a file read operation complete? executed from readLocalFile executed from
        // readHttpFile
        fileComplete   = <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileComplete(data) {</span>
<span class="cstat-no" title="statement not covered" >            var totalCalc = <span class="fstat-no" title="function not covered" >function pdNodeLocal__fileComplete_totalCalc() {</span></span>
<span class="cstat-no" title="statement not covered" >                total[1] += 1;</span>
<span class="cstat-no" title="statement not covered" >                if (total[1] === total[0]) {</span>
<span class="cstat-no" title="statement not covered" >                    ender();</span>
                }
...
<span class="cstat-no" title="statement not covered" >            if (options.report === true &amp;&amp; options.mode !== "diff" &amp;&amp; method !== "screen" &amp;&amp; method !== "filescreen" &amp;&amp; (options.mode !== "beautify" || options.jsscope === "none")) {</span>
<span class="cstat-no" title="statement not covered" >                total[0] += 2;</span>
            } else <span class="cstat-no" title="statement not covered" >if (options.mode !== "diff" || (options.mode === "diff" &amp;&amp; data.type === "diff")) {</span>
<span class="cstat-no" title="statement not covered" >                total[0] += 1;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (data.type === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                dfiledump[data.index] = data.file;</span>
<span class="cstat-no" title="statement not covered" >                dState[data.index]    = true;</span>
            } else {
<span class="cstat-no" title="statement not covered" >                sfiledump[data.index] = data.file;</span>
<span class="cstat-no" title="statement not covered" >                sState[data.index]    = true;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (data.index !== sfiledump.length - 1) {</span>
<span class="cstat-no" title="statement not covered" >                data.last = false;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (sState[data.index] === true &amp;&amp; ((options.mode === "diff" &amp;&amp; dState[data.index] === true) || options.mode !== "diff")) {</span>
<span class="cstat-no" title="statement not covered" >                if (options.mode === "diff" &amp;&amp; sfiledump[data.index] !== dfiledump[data.index]) {</span>
<span class="cstat-no" title="statement not covered" >                    if (dfiledump[data.index] === "" || dfiledump[data.index] === "\n") {</span>
<span class="cstat-no" title="statement not covered" >                        diffCount[0] += 1;</span>
<span class="cstat-no" title="statement not covered" >                        diffCount[0] += 1;</span>
<span class="cstat-no" title="statement not covered" >                        total[1]     += 1;</span>
<span class="cstat-no" title="statement not covered" >                        console.log("Diff file at " + data.localpath + " is \x1B[31mempty\x1B[39m but the source file is not.");</span>
<span class="cstat-no" title="statement not covered" >                        if (total[0] === total[1]) {</span>
<span class="cstat-no" title="statement not covered" >                            ender();</span>
                        }
                    } else <span class="cstat-no" title="statement not covered" >if (sfiledump[data.index] === "" || sfiledump[data.index] === "\n") {</span>
<span class="cstat-no" title="statement not covered" >                        diffCount[0] += 1;</span>
<span class="cstat-no" title="statement not covered" >                        diffCount[0] += 1;</span>
<span class="cstat-no" title="statement not covered" >                        total[1]     += 1;</span>
<span class="cstat-no" title="statement not covered" >                        console.log("Source file at " + data.localpath + " is \x1B[31mempty\x1B[39m but the diff file is not.");</span>
<span class="cstat-no" title="statement not covered" >                        if (total[0] === total[1]) {</span>
<span class="cstat-no" title="statement not covered" >                            ender();</span>
                        }
                    } else <span class="cstat-no" title="statement not covered" >if (options.diffcli === true) {</span>
<span class="cstat-no" title="statement not covered" >                        cliFile(data);</span>
                    } else <span class="cstat-no" title="statement not covered" >if (method === "filescreen") {</span>
<span class="cstat-no" title="statement not covered" >                        options.diff   = dfiledump[data.index];</span>
<span class="cstat-no" title="statement not covered" >                        options.source = sfiledump[data.index];</span>
<span class="cstat-no" title="statement not covered" >                        screenWrite();</span>
                    } else <span class="cstat-no" title="statement not covered" >if (method === "file" || method === "directory" || method === "subdirectory") {</span>
<span class="cstat-no" title="statement not covered" >                        fileWrite(data);</span>
                    }
<span class="cstat-no" title="statement not covered" >                    sState[data.index] = false;</span>
<span class="cstat-no" title="statement not covered" >                    if (options.mode === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                        dState[data.index] = false;</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (options.mode !== "diff" &amp;&amp; (method === "file" || method === "directory" || method === "subdirectory")) {</span>
<span class="cstat-no" title="statement not covered" >                    fileWrite(data);</span>
                } else <span class="cstat-no" title="statement not covered" >if (options.mode !== "diff" &amp;&amp; (method === "screen" || method === "filescreen")) {</span>
<span class="cstat-no" title="statement not covered" >                    options.source = data.file;</span>
<span class="cstat-no" title="statement not covered" >                    screenWrite();</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    totalCalc();</span>
                }
            }
        },
&nbsp;
        //read from a binary file
        readBinaryFile = <span class="fstat-no" title="function not covered" >function pdNodeLocal__readBinaryFile(data) {</span>
<span class="cstat-no" title="statement not covered" >            fs</span>
                .open(data.absolutepath, "r", <span class="fstat-no" title="function not covered" >function pdNodeLocal__readBinaryFile_open(err, fd) {</span>
<span class="cstat-no" title="statement not covered" >                    var buff = new Buffer(data.size);</span>
<span class="cstat-no" title="statement not covered" >                    if (err !== null) {</span>
<span class="cstat-no" title="statement not covered" >                        return pdNodeLocal__readBinaryFile(data);</span>
                    }
<span class="cstat-no" title="statement not covered" >                    fs</span>
                        .read(fd, buff, 0, data.size, 0, <span class="fstat-no" title="function not covered" >function pdNodeLocal__readBinaryFile_open_read(erra, bytesRead, buffer) {</span>
<span class="cstat-no" title="statement not covered" >                            if (erra !== null) {</span>
<span class="cstat-no" title="statement not covered" >                                return pdNodeLocal__readBinaryFile(data);</span>
                            }
<span class="cstat-no" title="statement not covered" >                            if (bytesRead &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                                data.file = buffer;</span>
                            }
<span class="cstat-no" title="statement not covered" >                            fileComplete(data);</span>
                        });
                });
        },
&nbsp;
        //read from a file and determine if text
        readLocalFile  = <span class="fstat-no" title="function not covered" >function pdNodeLocal__readLocalFile(data) {</span>
<span class="cstat-no" title="statement not covered" >            var open = <span class="fstat-no" title="function not covered" >function pdNodeLocal__readLocalFile_open() {</span></span>
<span class="cstat-no" title="statement not covered" >                fs</span>
                    .open(data.absolutepath, "r", <span class="fstat-no" title="function not covered" >function pdNodeLocal__readLocalFile_open_callback(err, fd) {</span>
<span class="cstat-no" title="statement not covered" >                        var msize = (data.size &lt; 100)</span>
                                ? data.size
                                : 100,
                            buff  = new Buffer(msize);
<span class="cstat-no" title="statement not covered" >                        if (err !== null) {</span>
<span class="cstat-no" title="statement not covered" >                            return pdNodeLocal__readLocalFile(data);</span>
                        }
<span class="cstat-no" title="statement not covered" >                        fs</span>
                            .read(fd, buff, 0, msize, 1, <span class="fstat-no" title="function not covered" >function pdNodeLocal__readLocalFile_open_callback_read(erra, bytes, buffer) {</span>
<span class="cstat-no" title="statement not covered" >                                if (erra !== null) {</span>
<span class="cstat-no" title="statement not covered" >                                    return pdNodeLocal__readLocalFile(data);</span>
                                }
<span class="cstat-no" title="statement not covered" >                                var bstring = buffer.toString("utf8", 0, buffer.length);</span>
<span class="cstat-no" title="statement not covered" >                                bstring = bstring.slice(2, bstring.length - 2);</span>
<span class="cstat-no" title="statement not covered" >                                if ((/[\u0002-\u0008]|[\u000e-\u001f]/).test(bstring) === true) {</span>
<span class="cstat-no" title="statement not covered" >                                    data.binary = true;</span>
<span class="cstat-no" title="statement not covered" >                                    readBinaryFile(data);</span>
                                } else {
<span class="cstat-no" title="statement not covered" >                                    data.binary = false;</span>
<span class="cstat-no" title="statement not covered" >                                    fs.readFile(data.absolutepath, {</span>
                                        encoding: "utf8"
                                    }, <span class="fstat-no" title="function not covered" >function pdNodeLocal__readLocalFile_open_callback_read_readFile(errb, dump) {</span>
<span class="cstat-no" title="statement not covered" >                                        if (errb !== null &amp;&amp; errb !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >                                            return pdNodeLocal__readLocalFile(data);</span>
                                        }
<span class="cstat-no" title="statement not covered" >                                        if (data.file === undefined) {</span>
<span class="cstat-no" title="statement not covered" >                                            data.file = "";</span>
                                        }
<span class="cstat-no" title="statement not covered" >                                        data.file += dump;</span>
<span class="cstat-no" title="statement not covered" >                                        fileComplete(data);</span>
...
<span class="cstat-no" title="statement not covered" >            if (data.size === undefined) {</span>
<span class="cstat-no" title="statement not covered" >                fs</span>
                    .stat(data.absolutepath, <span class="fstat-no" title="function not covered" >function pdNodeLocal__readLocalFile_stat(errx, stat) {</span>
<span class="cstat-no" title="statement not covered" >                        if (errx !== null) {</span>
<span class="cstat-no" title="statement not covered" >                            if ((typeof errx === "string" &amp;&amp; errx.indexOf("no such file or directory") &gt; 0) || (typeof errx === "object" &amp;&amp; errx.code === "ENOENT")) {</span>
<span class="cstat-no" title="statement not covered" >                                return console.log(errx);</span>
                            }
<span class="cstat-no" title="statement not covered" >                            return pdNodeLocal__readLocalFile(data);</span>
                        }
<span class="cstat-no" title="statement not covered" >                        data.size = stat.size;</span>
...
&nbsp;
        ...
        readHttpFile   = <span class="fstat-no" title="function not covered" >function pdNodeLocal__readHttpFile(data) {</span>
<span class="cstat-no" title="statement not covered" >            var file = ["", 0];</span>
<span class="cstat-no" title="statement not covered" >            http.get(data.absolutepath, <span class="fstat-no" title="function not covered" >function pdNodeLocal__readHttpFile_get(res) {</span></span>
<span class="cstat-no" title="statement not covered" >                file[1] = Number(res.headers["content-length"]);</span>
<span class="cstat-no" title="statement not covered" >                res.setEncoding("utf8");</span>
<span class="cstat-no" title="statement not covered" >                res.on("data", <span class="fstat-no" title="function not covered" >function pdNodeLocal__readHttpFile_get_response(chunk) {</span></span>
<span class="cstat-no" title="statement not covered" >                    file[0] += chunk;</span>
<span class="cstat-no" title="statement not covered" >                    if (file[0].length === file[1]) {</span>
<span class="cstat-no" title="statement not covered" >                        data.file = file[0];</span>
<span class="cstat-no" title="statement not covered" >                        if (data.type === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                            dfiledump[data.index] = file[0];</span>
                        } else {
<span class="cstat-no" title="statement not covered" >                            sfiledump[data.index] = file[0];</span>
                        }
<span class="cstat-no" title="statement not covered" >                        fileComplete(data);</span>
                    }
                });
...
&nbsp;
        ...
        directory      = <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory() {</span>
            ...
            // at this time
<span class="cstat-no" title="statement not covered" >            var sfiles  = {</span>
                    abspath    : [],
                    count      : 0,
                    directories: 1,
                    filepath   : [],
                ...
                readDir = <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory_readDir(start, listtype) {</span>
<span class="cstat-no" title="statement not covered" >                    fs</span>
                        .stat(start, <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory_readDir_stat(erra, stat) {</span>
<span class="cstat-no" title="statement not covered" >                            var item    = {},</span>
                                dirtest = <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory_readDir_stat_dirtest(itempath) {</span>
<span class="cstat-no" title="statement not covered" >                                    var pusher     = <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory_readDir_stat_dirtest_pusher(itempath) {</span></span>
<span class="cstat-no" title="statement not covered" >                                            if (listtype === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                                                dfiles</span>
                                                    .filepath
                                                    .push([
                                                        itempath.replace(address.dabspath + path.sep, ""),
                                                        itempath
                                                    ]);
                                            } else <span class="cstat-no" title="statement not covered" >if (listtype === "source") {</span>
<span class="cstat-no" title="statement not covered" >                                                sfiles</span>
                                                    .filepath
                                                    .push([
...
<span class="cstat-no" title="statement not covered" >                                            item.count += 1;</span>
                                        },
                                        preprocess = <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory_readDir_stat_dirtest_stat_preprocess() {</span>
<span class="cstat-no" title="statement not covered" >                                            var b      = 0,</span>
                                                ...
                                                sizer  = <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory_readDir_stat_dirtest_stat_preprocess_sizer(index, type, filename, finalone) {</span>
<span class="cstat-no" title="statement not covered" >                                                    fs</span>
                                                        .stat(filename[1], <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory_readDir_stat_dirtest_stat_preprocess_sizer_stat(errc, statb) {</span>
<span class="cstat-no" title="statement not covered" >                                                            var filesize = 0;</span>
<span class="cstat-no" title="statement not covered" >                                                            if (errc === null) {</span>
<span class="cstat-no" title="statement not covered" >                                                                filesize = statb.size;</span>
                                                            }
<span class="cstat-no" title="statement not covered" >                                                            readLocalFile({</span>
                                                ...
                                                sorter = <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory_readDir_stat_dirtest_stat_preprocess_sorter(a, b) {</span>
...
<span class="cstat-no" title="statement not covered" >                                                dfiles</span>
                                                    .filepath
                                                    .sort(sorter);
<span class="cstat-no" title="statement not covered" >                                                for (b = 0; b &lt; length; b += 1) {</span>
<span class="cstat-no" title="statement not covered" >                                                    dState.push(false);</span>
<span class="cstat-no" title="statement not covered" >                                                    sState.push(false);</span>
<span class="cstat-no" title="statement not covered" >                                                    sfiledump.push("");</span>
<span class="cstat-no" title="statement not covered" >                                                    dfiledump.push("");</span>
<span class="cstat-no" title="statement not covered" >                                                    if (sfiles.filepath[b][0] === dfiles.filepath[b][0]) {</span>
<span class="cstat-no" title="statement not covered" >                                                        if (b === length - 1) {</span>
<span class="cstat-no" title="statement not covered" >                                                            end = true;</span>
                                                        }
<span class="cstat-no" title="statement not covered" >                                                        sizer(b, "diff", dfiles.filepath[b], end);</span>
<span class="cstat-no" title="statement not covered" >                                                        sizer(b, "source", sfiles.filepath[b], end);</span>
                                                    } else {
<span class="cstat-no" title="statement not covered" >                                                        if (sfiles.filepath[b][0] &lt; dfiles.filepath[b][0]) {</span>
<span class="cstat-no" title="statement not covered" >                                                            if (options.diffcli === true) {</span>
<span class="cstat-no" title="statement not covered" >                                                                clidata[0].push(sfiles.filepath[b][0]);</span>
                                                            }
<span class="cstat-no" title="statement not covered" >                                                            if (length === dfiles.filepath.length) {</span>
<span class="cstat-no" title="statement not covered" >                                                                length += 1;</span>
                                                            }
<span class="cstat-no" title="statement not covered" >                                                            dfiles</span>
                                                                .filepath
                                                                .splice(b, 0, "");
                                                        } else <span class="cstat-no" title="statement not covered" >if (dfiles.filepath[b][0] &lt; sfiles.filepath[b][0]) {</span>
<span class="cstat-no" title="statement not covered" >                                                            if (options.diffcli === true) {</span>
<span class="cstat-no" title="statement not covered" >                                                                clidata[1].push(dfiles.filepath[b][0]);</span>
                                                            }
<span class="cstat-no" title="statement not covered" >                                                            if (length === sfiles.filepath.length) {</span>
<span class="cstat-no" title="statement not covered" >                                                                length += 1;</span>
                                                            }
<span class="cstat-no" title="statement not covered" >                                                            sfiles</span>
                                                                .filepath
...
<span class="cstat-no" title="statement not covered" >                                                        if (sfiles.filepath[b] !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >                                                            sizer(b, "source", sfiles.filepath[b], end);</span>
                                                        }
                                                    }
                                                } else {
...
<span class="cstat-no" title="statement not covered" >                                    if (itempath === "") {</span>
<span class="cstat-no" title="statement not covered" >                                        preprocess();</span>
                                    } else {
<span class="cstat-no" title="statement not covered" >                                        fs</span>
                                            .stat(itempath, <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory_readDir_stat_dirtest_stat(errb, stata) {</span>
<span class="cstat-no" title="statement not covered" >                                                if (errb !== null) {</span>
<span class="cstat-no" title="statement not covered" >                                                    return console.log(errb);</span>
                                                }
<span class="cstat-no" title="statement not covered" >                                                if (stata.isDirectory() === true) {</span>
<span class="cstat-no" title="statement not covered" >                                                    if (method === "subdirectory") {</span>
<span class="cstat-no" title="statement not covered" >                                                        item.directories += 1;</span>
<span class="cstat-no" title="statement not covered" >                                                        pdNodeLocal__directory_readDir(itempath, listtype);</span>
<span class="cstat-no" title="statement not covered" >                                                        item.count += 1;</span>
                                                    }
<span class="cstat-no" title="statement not covered" >                                                    if (method === "directory") {</span>
<span class="cstat-no" title="statement not covered" >                                                        item.total       -= 1;</span>
<span class="cstat-no" title="statement not covered" >                                                        item.directories = 0;</span>
                                                    }
                                                } else <span class="cstat-no" title="statement not covered" >if (stata.isFile() === true) {</span>
<span class="cstat-no" title="statement not covered" >                                                    pusher(itempath);</span>
                                                } else {
<span class="cstat-no" title="statement not covered" >                                                    if (listtype === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                                                        dfiles.total -= 1;</span>
                                                    } else {
<span class="cstat-no" title="statement not covered" >                                                        sfiles.total -= 1;</span>
                                                    }
<span class="cstat-no" title="statement not covered" >                                                    console.log(itempath + lf + "is an unsupported type");</span>
                                                }
<span class="cstat-no" title="statement not covered" >                                                if (options.mode === "diff" &amp;&amp; sfiles.count === sfiles.total &amp;&amp; dfiles.count === dfiles.total &amp;&amp; sfiles.directories === 0 &amp;&amp; dfiles.directories === 0)  {</span>
<span class="cstat-no" title="statement not covered" >                                                    return preprocess();</span>
                                                }
<span class="cstat-no" title="statement not covered" >                                                if (options.mode !== "diff" &amp;&amp; item.directories === 0 &amp;&amp; item.count === item.total) {</span>
<span class="cstat-no" title="statement not covered" >                                                    return preprocess();</span>
                                                }
                                            });
                                    }
...
<span class="cstat-no" title="statement not covered" >                            if (erra !== null) {</span>
<span class="cstat-no" title="statement not covered" >                                return console.log(erra);</span>
                            }
<span class="cstat-no" title="statement not covered" >                            if (stat.isDirectory() === true) {</span>
<span class="cstat-no" title="statement not covered" >                                fs</span>
                                    .readdir(start, <span class="fstat-no" title="function not covered" >function pdNodeLocal__directory_readDir_stat_readdir(errd, files) {</span>
<span class="cstat-no" title="statement not covered" >                                        var x         = 0,</span>
                                            filetotal = files.length;
<span class="cstat-no" title="statement not covered" >                                        if (errd !== null || filetotal === 0) {</span>
<span class="cstat-no" title="statement not covered" >                                            if (method === "subdirectory") {</span>
<span class="cstat-no" title="statement not covered" >                                                if (listtype === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                                                    dfiles.directories -= 1;</span>
                                                } else {
<span class="cstat-no" title="statement not covered" >                                                    sfiles.directories -= 1;</span>
                                                }
                                            }
<span class="cstat-no" title="statement not covered" >                                            if (errd !== null) {</span>
<span class="cstat-no" title="statement not covered" >                                                return console.log(errd);</span>
                                            }
<span class="cstat-no" title="statement not covered" >                                            if ((options.mode === "diff" &amp;&amp; sfiles.count === sfiles.total &amp;&amp; dfiles.count === dfiles.total &amp;&amp; sfiles.directories === 0 &amp;&amp; dfiles.directories === 0) || (options.mode !== "diff" &amp;&amp; sfiles.directories === 0 &amp;&amp; sfiles.count === sfiles.total)) {</span>
<span class="cstat-no" title="statement not covered" >                                                dirtest("");</span>
                                            }
<span class="cstat-no" title="statement not covered" >                                            return;</span>
                                        }
<span class="cstat-no" title="statement not covered" >                                        if (listtype === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                                            item = dfiles;</span>
                                        } else {
<span class="cstat-no" title="statement not covered" >                                            item = sfiles;</span>
                                        }
<span class="cstat-no" title="statement not covered" >                                        item.total += filetotal;</span>
<span class="cstat-no" title="statement not covered" >                                        for (x = 0; x &lt; filetotal; x += 1) {</span>
<span class="cstat-no" title="statement not covered" >                                            if (x === filetotal - 1) {</span>
<span class="cstat-no" title="statement not covered" >                                                item.directories -= 1;</span>
<span class="cstat-no" title="statement not covered" >                                                dirtest(start + path.sep + files[x]);</span>
                                            } else {
<span class="cstat-no" title="statement not covered" >                                                dirtest(start + path.sep + files[x]);</span>
                                            }
                                        }
...
<span class="cstat-no" title="statement not covered" >                                return console.log("path: " + start + " is not a directory");</span>
                            }
                        });
                };
<span class="cstat-no" title="statement not covered" >            readDir(address.sabspath, "source");</span>
<span class="cstat-no" title="statement not covered" >            if (options.mode === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                readDir(address.dabspath, "diff");</span>
            }
        };
&nbsp;
    ...
    (function pdNodeLocal__start() {
        var a         = process
            ...
            pathslash = <span class="fstat-no" title="function not covered" >function pdNodeLocal__start_pathslash(name, x) {</span>
<span class="cstat-no" title="statement not covered" >                var y        = x.indexOf("://"),</span>
                    z        = "",
                    itempath = "",
                    ind      = "",
                    odirs    = [],
                    olen     = 0,
                    basepath = "",
                    makeout  = <span class="fstat-no" title="function not covered" >function pdNodeLocal__start_pathslash_makeout() {</span>
<span class="cstat-no" title="statement not covered" >                        basepath = basepath + odirs[olen] + path.sep;</span>
<span class="cstat-no" title="statement not covered" >                        fs.mkdir(basepath, <span class="fstat-no" title="function not covered" >function pdNodeLocal__start_pathslash_makeout_mkdir(err) {</span></span>
<span class="cstat-no" title="statement not covered" >                            if (err !== undefined &amp;&amp; err !== null &amp;&amp; err.code !== "EEXIST") {</span>
<span class="cstat-no" title="statement not covered" >                                console.log(err);</span>
<span class="cstat-no" title="statement not covered" >                                outready = true;</span>
                            } else <span class="cstat-no" title="statement not covered" >if (olen &lt; odirs.length) {</span>
<span class="cstat-no" title="statement not covered" >                                olen += 1;</span>
<span class="cstat-no" title="statement not covered" >                                if (olen &lt; odirs.length) {</span>
<span class="cstat-no" title="statement not covered" >                                    pdNodeLocal__start_pathslash_makeout();</span>
                                } else {
<span class="cstat-no" title="statement not covered" >                                    outready = true;</span>
                                }
                            } else {
<span class="cstat-no" title="statement not covered" >                                outready = true;</span>
                    ...
                    abspath  = <span class="fstat-no" title="function not covered" >function pdNodeLocal__start_pathslash_abspath() {</span>
<span class="cstat-no" title="statement not covered" >                        var tree  = cwd.split(path.sep),</span>
                            ups   = [],
                            uplen = 0;
<span class="cstat-no" title="statement not covered" >                        if (itempath.indexOf("..") === 0) {</span>
<span class="cstat-no" title="statement not covered" >                            ups   = itempath</span>
                                .replace(/\.\.\//g, ".." + path.sep)
                                .split(".." + path.sep);
<span class="cstat-no" title="statement not covered" >                            uplen = ups.length;</span>
<span class="cstat-no" title="statement not covered" >                            do {</span>
<span class="cstat-no" title="statement not covered" >                                uplen -= 1;</span>
<span class="cstat-no" title="statement not covered" >                                tree.pop();</span>
                            } while (uplen &gt; 1);
<span class="cstat-no" title="statement not covered" >                            return tree.join(path.sep) + path.sep + ups[ups.length - 1];</span>
                        }
<span class="cstat-no" title="statement not covered" >                        if ((/^([a-z]:(\\|\/))/).test(itempath) === true || itempath.indexOf(path.sep) === 0) {</span>
<span class="cstat-no" title="statement not covered" >                            return itempath;</span>
                        }
<span class="cstat-no" title="statement not covered" >                        return path.join(cwd, itempath);</span>
                    };
<span class="cstat-no" title="statement not covered" >                if (name === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                    ind = 0;</span>
                }
<span class="cstat-no" title="statement not covered" >                if (name === "output") {</span>
<span class="cstat-no" title="statement not covered" >                    ind = 1;</span>
                }
<span class="cstat-no" title="statement not covered" >                if (name === "source") {</span>
<span class="cstat-no" title="statement not covered" >                    ind = 2;</span>
                }
<span class="cstat-no" title="statement not covered" >                if (x.indexOf("http://") === 0 || x.indexOf("https://") === 0) {</span>
<span class="cstat-no" title="statement not covered" >                    dir[ind] = 3;</span>
<span class="cstat-no" title="statement not covered" >                    return x;</span>
                }
<span class="cstat-no" title="statement not covered" >                if (y &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    itempath = x.replace(/\\/g, "/");</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    z        = x.slice(0, y);</span>
<span class="cstat-no" title="statement not covered" >                    x        = x.slice(y + 3);</span>
<span class="cstat-no" title="statement not covered" >                    itempath = z + "://" + x.replace(/\\/g, "/");</span>
                }
<span class="cstat-no" title="statement not covered" >                fs</span>
                    .stat(itempath, <span class="fstat-no" title="function not covered" >function pdNodeLocal__start_pathslash_stat(err, stat) {</span>
<span class="cstat-no" title="statement not covered" >                        if (err !== null) {</span>
<span class="cstat-no" title="statement not covered" >                            dir[ind] = -1;</span>
<span class="cstat-no" title="statement not covered" >                            return "";</span>
                        }
<span class="cstat-no" title="statement not covered" >                        if (stat.isDirectory() === true) {</span>
<span class="cstat-no" title="statement not covered" >                            dir[ind] = 1;</span>
                        } else <span class="cstat-no" title="statement not covered" >if (stat.isFile() === true) {</span>
<span class="cstat-no" title="statement not covered" >                            dir[ind] = 2;</span>
<span class="cstat-no" title="statement not covered" >                            if (name === "output") {</span>
<span class="cstat-no" title="statement not covered" >                                outready = true;</span>
                            }
                        } else {
...
<span class="cstat-no" title="statement not covered" >                if (name === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                    address.dabspath = abspath();</span>
<span class="cstat-no" title="statement not covered" >                    address.dorgpath = itempath;</span>
                }
<span class="cstat-no" title="statement not covered" >                if (name === "output") {</span>
<span class="cstat-no" title="statement not covered" >                    if (x === ".") {</span>
<span class="cstat-no" title="statement not covered" >                        address.oabspath = cwd;</span>
<span class="cstat-no" title="statement not covered" >                        address.oorgpath = cwd;</span>
<span class="cstat-no" title="statement not covered" >                        outready         = true;</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        itempath         = itempath.replace(/\//g, path.sep);</span>
<span class="cstat-no" title="statement not covered" >                        address.oabspath = abspath();</span>
<span class="cstat-no" title="statement not covered" >                        address.oorgpath = itempath;</span>
<span class="cstat-no" title="statement not covered" >                        if (address.oabspath.charAt(address.oabspath.length - 1) !== path.sep) {</span>
<span class="cstat-no" title="statement not covered" >                            address.oabspath = address.oabspath + path.sep;</span>
                        }
<span class="cstat-no" title="statement not covered" >                        basepath = address</span>
                            .oabspath
                            .replace(path.sep + address.oorgpath, "");
<span class="cstat-no" title="statement not covered" >                        odirs    = address</span>
                            .oorgpath
                            .split(path.sep);
<span class="cstat-no" title="statement not covered" >                        makeout();</span>
                    }
                }
<span class="cstat-no" title="statement not covered" >                if (name === "source") {</span>
<span class="cstat-no" title="statement not covered" >                    address.sabspath = abspath();</span>
<span class="cstat-no" title="statement not covered" >                    address.sorgpath = itempath;</span>
                }
<span class="cstat-no" title="statement not covered" >                return itempath;</span>
            };
        for (b = 0; b &lt; c; b += 1) {
<span class="cstat-no" title="statement not covered" >            e = [];</span>
<span class="cstat-no" title="statement not covered" >            f = a[b].indexOf(":");</span>
<span class="cstat-no" title="statement not covered" >            e.push(a[b].substring(0, f).replace(/(\s+)$/, ""));</span>
<span class="cstat-no" title="statement not covered" >            e.push(a[b].substring(f + 1).replace(/^(\s+)/, ""));</span>
<span class="cstat-no" title="statement not covered" >            d.push(e);</span>
        }
        c = d.length;
        for (b = 0; b &lt; c; b += 1) {
<span class="cstat-no" title="statement not covered" >            if (d[b].length === 2) {</span>
<span class="cstat-no" title="statement not covered" >                if (options.version === false &amp;&amp; d[b][0] === "" &amp;&amp; (d[b][1] === "help" || d[b][1] === "man" || d[b][1] === "manual")) {</span>
<span class="cstat-no" title="statement not covered" >                    help = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (help === false &amp;&amp; d[b][0] === "" &amp;&amp; (d[b][1] === "v" || d[b][1] === "version")) {</span>
<span class="cstat-no" title="statement not covered" >                    options.version = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "api") {</span>
<span class="cstat-no" title="statement not covered" >                    options.api = "node";</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "braceline" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.braceline = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "bracepadding" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.bracepadding = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if ((d[b][0] === "braces" &amp;&amp; d[b][1] === "allman") || (d[b][0] === "indent" &amp;&amp; d[b][1] === "allman")) {</span>
<span class="cstat-no" title="statement not covered" >                    options.braces = "allman";</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "color" &amp;&amp; (d[b][1] === "canvas" || d[b][1] === "shadow")) {</span>
<span class="cstat-no" title="statement not covered" >                    options.color = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "comments" &amp;&amp; d[b][1] === "noindent") {</span>
<span class="cstat-no" title="statement not covered" >                    options.comments = "noindent";</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "commline" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.commline = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "compressedcss" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.compressedcss = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "conditional" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.conditional = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "content" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.content = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "context" &amp;&amp; isNaN(d[b][1]) === false) {</span>
<span class="cstat-no" title="statement not covered" >                    options.context = Number(d[b][1]);</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "correct" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.correct = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "crlf" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.crlf = true;</span>
<span class="cstat-no" title="statement not covered" >                    lf           = "\r\n";</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "cssinsertlines" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.cssinsertlines = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "csvchar" &amp;&amp; d[b][1].length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    options.csvchar = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "diff" &amp;&amp; d[b][1].length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    options.diff = pathslash(d[b][0], d[b][1]);</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "diffcli" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.diffcli = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "diffcomments" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.diffcomments = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "difflabel" &amp;&amp; d[b][1].length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    options.difflabel = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "diffspaceignore" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.diffspaceignore = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "diffview" &amp;&amp; d[b][1] === "inline") {</span>
<span class="cstat-no" title="statement not covered" >                    options.diffview = "inline";</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "dustjs" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.dustjs = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "elseline" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.elseline = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "endcomma" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.endcomma = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "endquietly") {</span>
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "quiet") {</span>
<span class="cstat-no" title="statement not covered" >                        enderflag = true;</span>
<span class="cstat-no" title="statement not covered" >                        options.endquietly = "quiet";</span>
                    } else <span class="cstat-no" title="statement not covered" >if (d[b][1] === "log") {</span>
<span class="cstat-no" title="statement not covered" >                        options.endquietly = "log";</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "force_attribute" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.force_attribute = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "force_indent" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.force_indent = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "html" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.html = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "inchar" &amp;&amp; d[b][1].length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    d[b][1]        = d[b][1]</span>
                        .replace(/\\t/g, "\u0009")
                        .replace(/\\n/g, "\u000a")
                        .replace(/\\r/g, "\u000d")
                        .replace(/\\f/g, "\u000c")
                        .replace(/\\b/g, "\u0008");
<span class="cstat-no" title="statement not covered" >                    options.inchar = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "inlevel" &amp;&amp; isNaN(d[b][1]) === false) {</span>
<span class="cstat-no" title="statement not covered" >                    options.inlevel = Number(d[b][1]);</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "insize" &amp;&amp; isNaN(d[b][1]) === false) {</span>
<span class="cstat-no" title="statement not covered" >                    options.insize = Number(d[b][1]);</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "jsscope") {</span>
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                        options.jsscope = "report";</span>
                    } else <span class="cstat-no" title="statement not covered" >if (d[b][1] === "report" || d[b][1] === "html") {</span>
<span class="cstat-no" title="statement not covered" >                        options.jsscope = d[b][1];</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        options.jsscope = "none";</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "lang" &amp;&amp; (d[b][1] === "markup" || d[b][1] === "javascript" || d[b][1] === "css" || d[b][1] === "html" || d[b][1] === "csv" || d[b][1] === "text")) {</span>
<span class="cstat-no" title="statement not covered" >                    options.lang = d[b][1];</span>
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "html") {</span>
<span class="cstat-no" title="statement not covered" >                        options.html = true;</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "langdefault" &amp;&amp; (d[b][1] === "markup" || d[b][1] === "javascript" || d[b][1] === "css" || d[b][1] === "html" || d[b][1] === "csv")) {</span>
<span class="cstat-no" title="statement not covered" >                    options.langdefault = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "methodchain") {</span>
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "true" || d[b][1] === "chain") {</span>
<span class="cstat-no" title="statement not covered" >                        options.methodchain = "chain";</span>
                    } else <span class="cstat-no" title="statement not covered" >if (d[b][1] === "none") {</span>
<span class="cstat-no" title="statement not covered" >                        options.methodchain = "none";</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        options.methodchain = "indent";</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "miniwrap" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.miniwrap = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "mode" &amp;&amp; (d[b][1] === "minify" || d[b][1] === "beautify" || d[b][1] === "parse")) {</span>
<span class="cstat-no" title="statement not covered" >                    options.mode = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "neverflatten" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.neverflatten = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "nocaseindent" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.nocaseindent = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "nochainindent" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.nochainindent = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "noleadzero" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.noleadzero = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "objsort") {</span>
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "all" || d[b][1] === "none" || d[b][1] === "css" || d[b][1] === "js" || d[b][1] === "markup") {</span>
<span class="cstat-no" title="statement not covered" >                        options.objsort = d[b][1];</span>
                    } else <span class="cstat-no" title="statement not covered" >if (d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                        options.objsort = "js";</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "output" &amp;&amp; d[b][1].length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    options.output = pathslash(d[b][0], d[b][1]);</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "preserve") {</span>
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === 1 || d[b][1] === undefined || d[b][1] === "true" || d[b][1] === "all" || d[b][1] === "js" || d[b][1] === "css") {</span>
<span class="cstat-no" title="statement not covered" >                        options.preserve = 1;</span>
                    } else <span class="cstat-no" title="statement not covered" >if (d[b][1] === "false" || isNaN(d[b][1]) === true || Number(d[b][1]) &lt; 1 || d[b][1] === "none") {</span>
<span class="cstat-no" title="statement not covered" >                        options.preserve = 0;</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        options.preserve = Number(d[b][1]);</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "quote" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.quote = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "quoteConvert" &amp;&amp; (d[b][1] === "single" || d[b][1] === "double")) {</span>
<span class="cstat-no" title="statement not covered" >                    options.quoteConvert = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "readmethod") {</span>
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "auto") {</span>
<span class="cstat-no" title="statement not covered" >                        options.readmethod = "auto";</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "file") {</span>
<span class="cstat-no" title="statement not covered" >                        options.readmethod = "file";</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "filescreen") {</span>
<span class="cstat-no" title="statement not covered" >                        options.readmethod = "filescreen";</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "directory") {</span>
<span class="cstat-no" title="statement not covered" >                        options.readmethod = "directory";</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "subdirectory") {</span>
<span class="cstat-no" title="statement not covered" >                        options.readmethod = "subdirectory";</span>
                    }
<span class="cstat-no" title="statement not covered" >                    method = options.readmethod;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "report") {</span>
<span class="cstat-no" title="statement not covered" >                    options.output = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "selectorlist" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.selectorlist = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "semicolon" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.semicolon = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "source" &amp;&amp; d[b][1].length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    options.source = pathslash(d[b][0], d[b][1]);</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "sourcelabel" &amp;&amp; d[b][1].length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                    options.sourcelabel = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "space" &amp;&amp; d[b][1] === "false") {</span>
<span class="cstat-no" title="statement not covered" >                    options.space = false;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "spaceclose" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.spaceclose = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "style" &amp;&amp; d[b][1] === "noindent") {</span>
<span class="cstat-no" title="statement not covered" >                    options.style = "noindent";</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "styleguide") {</span>
<span class="cstat-no" title="statement not covered" >                    options.styleguide = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "summaryonly" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.summaryonly = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "tagmerge" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.tagmerge = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "tagsort" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.tagsort = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "ternaryline" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.ternaryline = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "textpreserve" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.textpreserve = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "titanium" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.titanium = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "topcoms" &amp;&amp; d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                    options.topcoms = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "varword" &amp;&amp; (d[b][1] === "each" || d[b][1] === "list")) {</span>
<span class="cstat-no" title="statement not covered" >                    options.varword = d[b][1];</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "vertical") {</span>
<span class="cstat-no" title="statement not covered" >                    if (d[b][1] === "all" || d[b][1] === "none" || d[b][1] === "css" || d[b][1] === "js") {</span>
<span class="cstat-no" title="statement not covered" >                        options.vertical = d[b][1];</span>
                    } else <span class="cstat-no" title="statement not covered" >if (d[b][1] === "true") {</span>
<span class="cstat-no" title="statement not covered" >                        options.vertical = "all";</span>
                    }
                } else <span class="cstat-no" title="statement not covered" >if (d[b][0] === "wrap") {</span>
<span class="cstat-no" title="statement not covered" >                    if (isNaN(d[b][1]) === true) {</span>
<span class="cstat-no" title="statement not covered" >                        options.wrap = 80;</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        options.wrap = Number(d[b][1]);</span>
                    }
                }
            } else <span class="cstat-no" title="statement not covered" >if (help === false &amp;&amp; options.version === false) {</span>
<span class="cstat-no" title="statement not covered" >                if (d[b] === "help" || d[b][0] === "help" || d[b][0] === "man" || d[b][0] === "manual") {</span>
<span class="cstat-no" title="statement not covered" >                    help = true;</span>
                } else <span class="cstat-no" title="statement not covered" >if (d[b] === "v" || d[b] === "version" || d[b][0] === "v" || d[b][0] === "version") {</span>
<span class="cstat-no" title="statement not covered" >                    options.version = true;</span>
                }
            }
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (options.output === "") {
            outready = true;
        }
&nbsp;
        fs
            .stat(pdrcpath, function pdNodeLocal__start_stat(err, stats) {
                var init = function pdNodeLocal__start_stat_init() {
                    var state   = true,
                        cliflag = false,
                        status  = <span class="fstat-no" title="function not covered" >function pdNodeLocal__start_stat_init_status() {</span>
<span class="cstat-no" title="statement not covered" >                            var tempaddy = "";</span>
...
<span class="cstat-no" title="statement not covered" >                            if (dir[2] === 0) {</span>
<span class="cstat-no" title="statement not covered" >                                return;</span>
                            }
<span class="cstat-no" title="statement not covered" >                            if (method === "auto") {</span>
<span class="cstat-no" title="statement not covered" >                                if (dir[2] === 1) {</span>
<span class="cstat-no" title="statement not covered" >                                    method = "subdirectory";</span>
                                } else <span class="cstat-no" title="statement not covered" >if (dir[2] &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >                                    if (options.output === "") {</span>
<span class="cstat-no" title="statement not covered" >                                        method = "filescreen";</span>
                                    } else {
<span class="cstat-no" title="statement not covered" >                                        if (options.output === "" &amp;&amp; options.mode !== "diff") {</span>
<span class="cstat-no" title="statement not covered" >                                            console.log("");</span>
<span class="cstat-no" title="statement not covered" >                                            console.log("\x1B[91mNo output option is specified, so no files written.\x1B[39m");</span>
<span class="cstat-no" title="statement not covered" >                                            console.log("");</span>
                                        }
<span class="cstat-no" title="statement not covered" >                                        method = "file";</span>
<span class="cstat-no" title="statement not covered" >                                        if (options.output === "") {</span>
<span class="cstat-no" title="statement not covered" >                                            return console.log("Error: 'readmethod' is value 'file' and argument 'output' is empty");</span>
                                        }
                                    }
                                } else <span class="cstat-no" title="statement not covered" >if (dir[2] &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                                    method = "screen";</span>
                                }
                            }
<span class="cstat-no" title="statement not covered" >                            if (dir[2] &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                                state = false;</span>
<span class="cstat-no" title="statement not covered" >                                if (options.readmethod === "screen" &amp;&amp; options.mode !== "diff") {</span>
<span class="cstat-no" title="statement not covered" >                                    return screenWrite();</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (options.readmethod !== "screen") {</span>
<span class="cstat-no" title="statement not covered" >                                    if (options.readmethod === "auto") {</span>
<span class="cstat-no" title="statement not covered" >                                        method = "screen";</span>
<span class="cstat-no" title="statement not covered" >                                        if (options.mode !== "diff") {</span>
<span class="cstat-no" title="statement not covered" >                                            return screenWrite();</span>
                                        }
                                    } else {
<span class="cstat-no" title="statement not covered" >                                        return console.log("source is not a directory or file");</span>
                                    }
                                }
                            }
<span class="cstat-no" title="statement not covered" >                            if (dir[2] === 1 &amp;&amp; method !== "directory" &amp;&amp; method !== "subdirectory") {</span>
<span class="cstat-no" title="statement not covered" >                                state = false;</span>
<span class="cstat-no" title="statement not covered" >                                return console.log("source is a directory but readmethod option is not 'auto', 'directory', or 'subd" +</span>
                                        "irectory'");
                            }
<span class="cstat-no" title="statement not covered" >                            if (dir[2] &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >                                if (method === "directory" || method === "subdirectory") {</span>
<span class="cstat-no" title="statement not covered" >                                    state = false;</span>
<span class="cstat-no" title="statement not covered" >                                    return console.log("source is a file but readmethod option is 'directory' or 'subdirectory'");</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (method === "screen") {</span>
<span class="cstat-no" title="statement not covered" >                                    method = "filescreen";</span>
                                }
                            }
<span class="cstat-no" title="statement not covered" >                            if (options.mode === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                                if (dir[0] === 0 || dir[2] === 0) {</span>
<span class="cstat-no" title="statement not covered" >                                    return;</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (dir[0] &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                                    state = false;</span>
<span class="cstat-no" title="statement not covered" >                                    if (options.readmethod === "auto" || (dir[2] &lt; 0 &amp;&amp; options.readmethod === "screen")) {</span>
<span class="cstat-no" title="statement not covered" >                                        if (options.readmethod === "auto" &amp;&amp; method === "screen" &amp;&amp; cliflag === true &amp;&amp; options.diffcli === false) {</span>
<span class="cstat-no" title="statement not covered" >                                            options.diffcli = false;</span>
                                        }
<span class="cstat-no" title="statement not covered" >                                        if (options.diffcli === true) {</span>
<span class="cstat-no" title="statement not covered" >                                            return cliWrite(prettydiff.api(options), "", false);</span>
                                        }
...
<span class="cstat-no" title="statement not covered" >                                    return console.log("diff is not a directory or file");</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (dir[0] === 1 &amp;&amp; method !== "directory" &amp;&amp; method !== "subdirectory") {</span>
<span class="cstat-no" title="statement not covered" >                                    state = false;</span>
<span class="cstat-no" title="statement not covered" >                                    return console.log("diff is a directory but readmethod option is not 'directory' or 'subdirectory'");</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (dir[0] &gt; 2 &amp;&amp; (method === "directory" || method === "subdirectory")) {</span>
<span class="cstat-no" title="statement not covered" >                                    state = false;</span>
<span class="cstat-no" title="statement not covered" >                                    return console.log("diff is a file but readmethod option is 'directory' or 'subdirectory'");</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (dir[0] &gt; 1 &amp;&amp; method === "screen") {</span>
<span class="cstat-no" title="statement not covered" >                                    method = "filescreen";</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (dir[0] &gt; 1 &amp;&amp; dir[2] &gt; 1 &amp;&amp; (method === "file" || method === "filescreen")) {</span>
<span class="cstat-no" title="statement not covered" >                                    state = false;</span>
<span class="cstat-no" title="statement not covered" >                                    dState.push(false);</span>
<span class="cstat-no" title="statement not covered" >                                    sState.push(false);</span>
<span class="cstat-no" title="statement not covered" >                                    if (dir[0] === 3) {</span>
<span class="cstat-no" title="statement not covered" >                                        readHttpFile({absolutepath: options.diff, index: 0, last: true, localpath: options.diff, type: "diff"});</span>
                                    } else {
<span class="cstat-no" title="statement not covered" >                                        tempaddy = options</span>
                                            .diff
                                            .replace(/(\/|\\)/g, path.sep);
<span class="cstat-no" title="statement not covered" >                                        readLocalFile({absolutepath: tempaddy, index: 0, last: true, localpath: tempaddy, type: "diff"});</span>
                                    }
<span class="cstat-no" title="statement not covered" >                                    if (dir[2] === 3) {</span>
<span class="cstat-no" title="statement not covered" >                                        readHttpFile({absolutepath: options.source, index: 0, last: true, localpath: options.source, type: "source"});</span>
                                    } else {
<span class="cstat-no" title="statement not covered" >                                        tempaddy = options</span>
                                            .source
                                            .replace(/(\/|\\)/g, path.sep);
<span class="cstat-no" title="statement not covered" >                                        readLocalFile({absolutepath: tempaddy, index: 0, last: true, localpath: tempaddy, type: "source"});</span>
                                    }
<span class="cstat-no" title="statement not covered" >                                    return;</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (dir[0] === 1 &amp;&amp; dir[2] === 1 &amp;&amp; (method === "directory" || method === "subdirectory")) {</span>
<span class="cstat-no" title="statement not covered" >                                    state = false;</span>
<span class="cstat-no" title="statement not covered" >                                    return directory();</span>
                                }
                            } else {
<span class="cstat-no" title="statement not covered" >                                if (dir[2] &gt; 1 &amp;&amp; (method === "file" || method === "filescreen")) {</span>
<span class="cstat-no" title="statement not covered" >                                    state = false;</span>
<span class="cstat-no" title="statement not covered" >                                    sState.push(false);</span>
<span class="cstat-no" title="statement not covered" >                                    if (dir[2] === 3) {</span>
<span class="cstat-no" title="statement not covered" >                                        readHttpFile({absolutepath: options.source, index: 0, last: true, localpath: options.source, type: "source"});</span>
                                    } else {
<span class="cstat-no" title="statement not covered" >                                        readLocalFile({absolutepath: options.source, index: 0, last: true, localpath: options.source, type: "source"});</span>
                                    }
<span class="cstat-no" title="statement not covered" >                                    return;</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (dir[2] === 1 &amp;&amp; (method === "directory" || method === "subdirectory")) {</span>
...
<span class="cstat-no" title="statement not covered" >                                    return directory();</span>
                        ...
                        delay   = <span class="fstat-no" title="function not covered" >function pdNodeLocal__start_stat_init_delay() {</span>
<span class="cstat-no" title="statement not covered" >                            if (state === true || outready === false) {</span>
<span class="cstat-no" title="statement not covered" >                                status();</span>
<span class="cstat-no" title="statement not covered" >                                setTimeout(<span class="fstat-no" title="function not covered" >function pdNodeLocal__start_stat_init_delay_setTimeout() {</span></span>
<span class="cstat-no" title="statement not covered" >                                    pdNodeLocal__start_stat_init_delay();</span>
                                }, 50);
                            }
                        };
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (alphasort === true) {
<span class="cstat-no" title="statement not covered" >                        options.objsort = "all";</span>
                    }
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.lang === "tss") {
<span class="cstat-no" title="statement not covered" >                        options.titanium = true;</span>
<span class="cstat-no" title="statement not covered" >                        options.lang     = "javascript";</span>
                    }
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.mode !== "diff") {
<span class="cstat-no" title="statement not covered" >                        options.diffcli     = false;</span>
<span class="cstat-no" title="statement not covered" >                        options.summaryonly = false;</span>
                    }
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.summaryonly === true) {
<span class="cstat-no" title="statement not covered" >                        options.diffcli = true;</span>
                    }
&nbsp;
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (help === true) {
                        return console.log(error);
                    }
<span class="cstat-no" title="statement not covered" >                    if (c === 1 &amp;&amp; options.version === true) {</span>
<span class="cstat-no" title="statement not covered" >                        return console.log(versionString);</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (options.source === "") {</span>
<span class="cstat-no" title="statement not covered" >                        return console.log("Error: 'source' argument is empty");</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (options.mode === "diff" &amp;&amp; options.diff === "") {</span>
<span class="cstat-no" title="statement not covered" >                        return console.log("Error: 'diff' argument is empty");</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if ((options.mode === "diff" &amp;&amp; options.summaryonly === false) || (options.jsscope !== "none" &amp;&amp; options.mode === "beautify")) {</span>
<span class="cstat-no" title="statement not covered" >                        options.report = true;</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if ((options.output === "" || options.summaryonly === true) &amp;&amp; options.mode === "diff") {</span>
<span class="cstat-no" title="statement not covered" >                        if (options.readmethod !== "screen") {</span>
<span class="cstat-no" title="statement not covered" >                            if (options.readmethod === "auto") {</span>
<span class="cstat-no" title="statement not covered" >                                cliflag = true;</span>
                            } else {
<span class="cstat-no" title="statement not covered" >                                options.diffcli = true;</span>
                            }
                        }
<span class="cstat-no" title="statement not covered" >                        if (process.argv.join(" ").indexOf(" context:") === -1) {</span>
<span class="cstat-no" title="statement not covered" >                            options.context = 2;</span>
                        }
                    }
<span class="cstat-no" title="statement not covered" >                    if (method === "file" &amp;&amp; options.output === "" &amp;&amp; options.summaryonly === false &amp;&amp; options.diffcli === false) {</span>
<span class="cstat-no" title="statement not covered" >                        return console.log("Error: 'readmethod' is value 'file' and argument 'output' is empty");</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (options.summaryonly === true) {</span>
<span class="cstat-no" title="statement not covered" >                        options.report = false;</span>
                    }
<span class="cstat-no" title="statement not covered" >                    if (dir[2] === 0 || outready === false || (options.mode === "diff" &amp;&amp; dir[0] === 0)) {</span>
...
<span class="cstat-no" title="statement not covered" >                    init();</span>
                } else <span class="missing-if-branch" title="else path not taken" >E</span>if (stats.isFile() === true) {
                    fs
                        .readFile(pdrcpath, {
                            encoding: "utf8"
                            ...
                            var s       = options.source,
                                ...
                                pdrc    = {},
                                pdkeys  = [],
                                eachkey = <span class="fstat-no" title="function not covered" >function pdNodeLocal__start_stat_readFile_eachkey(val) {</span>
<span class="cstat-no" title="statement not covered" >                                    if (val !== "help" &amp;&amp; val !== "version" &amp;&amp; val !== "v" &amp;&amp; val !== "man" &amp;&amp; val !== "manual") {</span>
...
<span class="cstat-no" title="statement not covered" >                                            options[val] = pdrc[val];</span>
<span class="cstat-no" title="statement not covered" >                                            if (val === "help" &amp;&amp; pdrc[val] === true) {</span>
<span class="cstat-no" title="statement not covered" >                                                h = true;</span>
<span class="cstat-no" title="statement not covered" >                                                b -= 1;</span>
                                            }
                                        }
                                    }
                                };
                            <span class="missing-if-branch" title="if path not taken" >I</span>if (error !== null &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >error !== undefined)</span> {
<span class="cstat-no" title="statement not covered" >                                return init();</span>
                            }
                            <span class="missing-if-branch" title="if path not taken" >I</span>if ((/^(\s*\{)/).test(data) === true &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >(/(\}\s*)$/).test(data) === true)</span> {
<span class="cstat-no" title="statement not covered" >                                pdrc   = JSON.parse(data);</span>
<span class="cstat-no" title="statement not covered" >                                pdkeys = Object.keys(pdrc);</span>
<span class="cstat-no" title="statement not covered" >                                b      = 0;</span>
<span class="cstat-no" title="statement not covered" >                                pdkeys.forEach(eachkey);</span>
<span class="cstat-no" title="statement not covered" >                                if (b &gt; 0 &amp;&amp; h === false) {</span>
<span class="cstat-no" title="statement not covered" >                                    help = false;</span>
                                }
<span class="cstat-no" title="statement not covered" >                                method = options.readmethod;</span>
<span class="cstat-no" title="statement not covered" >                                if (s !== options.source) {</span>
<span class="cstat-no" title="statement not covered" >                                    pathslash("source", options.source);</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (dd !== options.diff) {</span>
<span class="cstat-no" title="statement not covered" >                                    pathslash("diff", options.diff);</span>
                                }
<span class="cstat-no" title="statement not covered" >                                if (o !== options.output) {</span>
<span class="cstat-no" title="statement not covered" >                                    pathslash("output", options.output);</span>
                                }
<span class="cstat-no" title="statement not covered" >                                init();</span>
                            } else {
                                pdrc = require(pdrcpath);
                                <span class="missing-if-branch" title="else path not taken" >E</span>if (pdrc.preset !== undefined) {
                                    options = pdrc.preset(options);
                                    method  = options.readmethod;
                                    <span class="missing-if-branch" title="if path not taken" >I</span>if (s !== options.source) {
<span class="cstat-no" title="statement not covered" >                                        pathslash("source", options.source);</span>
                                    }
                                    <span class="missing-if-branch" title="if path not taken" >I</span>if (dd !== options.diff) {
<span class="cstat-no" title="statement not covered" >                                        pathslash("diff", options.diff);</span>
                                    }
                                    <span class="missing-if-branch" title="if path not taken" >I</span>if (o !== options.output) {
<span class="cstat-no" title="statement not covered" >                                        pathslash("output", options.output);</span>
                                    }
                                    help = false;
                                    <span class="missing-if-branch" title="else path not taken" >E</span>if (options.help === true &amp;&amp; (process.argv.length &lt; 3 || <span class="branch-2 cbranch-no" title="branch not covered" >options.source === undefined </span>|| <span class="branch-3 cbranch-no" title="branch not covered" >options.source === "")</span>) {
                                        help = true;
                                    }
                                    init();
                                }
...
<span class="cstat-no" title="statement not covered" >                    init();</span>
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (c === 0) {
                    help = true;
                }
            });
    }());
